<template>
    <div :class='[boxClasses]'
        ...
        <div :class='selectGroupClasses'
                ...
                <div :class='[`${prefixCls}-main-flex`]' :style='[selectWidth]'>
                    ...
                    <template v-if='multiple'>
                        <div
                            ...
                            <Icon type='quxiao-guanbi-shanchu'
            ...
            <div :class="[prefixCls+`-icon`]" @click="toggleMenu">
                <Icon
                    type='xia'
                ...
                return [
                    {
                        ...
                        [`${prefixCls}-group-fixed-focused`]: this.show && !!this.label && !!this.fixed
                    }
                ]
            },
            classes () {
    ...
    watch: {
        ...
        values (now, before) {
            ...
            if (emitInput) {
                ...
                this.dispatch(`${prefix}form-item`, 'on-form-change', nameInCode ? values : publicValue)
            }
        },
        show (val) {
        ...
        selectOptions (now, before) {
            ...
            if (newValue !== oldValue) {
                ...
                // this.dispatch(`${prefix}form-item`, 'on-form-change', nameInCode ? this.values : value)
            }
            this.broadcastPopperUpdate()
        },
        options (now, before) {
