<template>
    <div :class="wrapClasses" style="touch-action: none;">
        ...
        >
            <!-- top loader -->
            <div ref="toploader" :class="loaderClasses" :style="{ paddingTop: wrapperPadding.paddingTop }">
                <b-loader :text="localeLoadingText" :active="showTopLoader"></b-loader>
            </div>
            <div :class="slotContainerClasses" ref="scrollContent">
                <slot></slot>
            </div>
            <!-- bottom loader -->
            <div ref="bottomLoader" :class="loaderClasses" :style="{ paddingBottom: wrapperPadding.paddingBottom }">
                <b-loader :text="localeLoadingText" :active="showBottomLoader"></b-loader>
            </div>
        </div>
    </div>
</template>
<script>
    import BLoader from './loading'
    import { on, off } from '../../utils/dom'
    import { throttle } from '../../utils/assist'
    import { prefix } from '../../utils/common'
    const prefixCls = `${prefix}scroll`
