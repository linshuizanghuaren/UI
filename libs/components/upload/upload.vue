...
<script>
import BUploadList from './upload-list'
...
export default {
        ...
        methods: {
            ...
            // 对文件进行校验
            fileCheck (file) {
                let formatCheckRes = this.formatCheck(file)
                let maxSizeCheckRes = this.maxSizeCheck(file)
                return formatCheckRes && maxSizeCheckRes
            },
            // 格式校验
            formatCheck (file) {
                // check format
            ...
            handleSuccess (res, file) {
                ...
                if (_file) {
                    ...
                    this.dispatch(`${prefix}form-item`, 'on-form-change', _file)
                    setTimeout(() => {
